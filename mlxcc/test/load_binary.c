 ...
 * the License.
 *
 * load_binary.c - binary content loading example.
 *
 *============================================================================*/
...
int main() {
    ...
    /* load from file */
    errcode = xcc_content_setop(content, XCC_CONTENT_OPT_FILE, "downloadbug.gif");
    if(errcode != XCC_OK) {
    ...
    xcc_content_setop(content, XCC_CONTENT_OPT_URI, "http://mysite.com/images/dload.gif");
    xcc_content_setop(content, XCC_CONTENT_OPT_FORMAT, XCC_CONTENT_FORMAT_BINARY);
